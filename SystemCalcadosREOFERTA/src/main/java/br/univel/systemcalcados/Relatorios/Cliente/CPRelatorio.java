package br.univel.systemcalcados.Relatorios.Cliente;
 ...
 * @author Luiz Doreto
 */
public class CPRelatorio {

    public CPRelatorio() {

        String outFileName = "cliente.pdf";
        ...
        try {
            ...
            InputStream is = getClass().getResourceAsStream("cli.jasper");
