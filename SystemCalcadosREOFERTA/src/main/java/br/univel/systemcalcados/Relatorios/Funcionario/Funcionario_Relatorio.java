package br.univel.systemcalcados.Relatorios.Funcionario;
 ...
 * @author Smart Web
 */
public class Funcionario_Relatorio {

    public Funcionario_Relatorio() {

        String outFileName = "funcionario.pdf";
        ...
        try {
            ...
            InputStream is = getClass().getResourceAsStream("func.jasper");
