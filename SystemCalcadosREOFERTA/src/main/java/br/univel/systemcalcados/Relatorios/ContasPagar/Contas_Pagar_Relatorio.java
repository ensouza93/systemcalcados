package br.univel.systemcalcados.Relatorios.ContasPagar;
 ...
 * @author Smart Web
 */
public class Contas_Pagar_Relatorio {

    public Contas_Pagar_Relatorio() {

        String outFileName = "contaspagar.pdf";
        ...
        try {
            ...
            InputStream is = getClass().getResourceAsStream("contasPagar.jasper");
