package br.univel.systemcalcados.Relatorios.CondicoesPagamento;
 ...
 * @author Smart Web
 */
public class Condicoes_Pagamento_Relatorio {

    public Condicoes_Pagamento_Relatorio() {

        String outFileName = "condicoespagamento.pdf";
        ...
        try {
            ...
            InputStream is = getClass().getResourceAsStream("condP.jasper");
