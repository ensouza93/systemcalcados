package br.univel.systemcalcados.Relatorios.FormasPagamento;
 ...
 * @author Smart Web
 */
public class Forma_Relatorio {

    public Forma_Relatorio() {

        String outFileName = "fp.pdf";
        ...
        try {
            ...
            InputStream is = getClass().getResourceAsStream("formaP.jasper");
