package br.univel.systemcalcados.Relatorios.ContasReceber;
 ...
 * @author Smart Web
 */
public class Contas_Receber_Relatorio {

    public Contas_Receber_Relatorio() {

        String outFileName = "contasreceber.pdf";
        ...
        try {
            ...
            InputStream is = getClass().getResourceAsStream("contasReceber.jasper");
