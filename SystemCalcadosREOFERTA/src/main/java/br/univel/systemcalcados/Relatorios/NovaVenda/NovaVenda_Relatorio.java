package br.univel.systemcalcados.Relatorios.NovaVenda;
 ...
 * @author Smart Web
 */
public class NovaVenda_Relatorio {

    public NovaVenda_Relatorio() {

        String outFileName = "novavenda.pdf";
        ...
        try {
            ...
            InputStream is = getClass().getResourceAsStream("novaVenda.jasper");
